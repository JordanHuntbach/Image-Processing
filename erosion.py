...
# this sets the value of each pixel to the minimum value that is within the structuring element, when centered on the
...
def erosion(img, out):
    ...
    for pixel_y in range(0, w):
        for pixel_x in range(0, h):
            ...
            new[pixel_y][pixel_x] = numpy.amin(roi)
